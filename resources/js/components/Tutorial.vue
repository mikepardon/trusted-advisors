    ...
    steps() {
      return [
        ...
        [
          'Items & Events',
          '',
          'Items grant special abilities:',
          'extra dice, stat boosts, and more.',
          '',
          'Cursed items hurt you each round.',
          'Use "Remove Curse" to cleanse them.',
          '',
          'Random events may trigger each round,',
          'bringing fortune or disaster.',
        ],
        [
          'Victory & Defeat',
          '',
          'Cooperative: Survive all 24 months.',
          'Your total score determines your rank.',
          '',
          'Duel: Two rival kingdoms compete.',
          'Reach 20 in 3 stats to win,',
          'or let your opponent hit 0 in any stat.',
          '',
