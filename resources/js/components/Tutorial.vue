    ...
    steps() {
      return [
        ...
        [
          'Scoring',
          '',
          'Your final score combines several bonuses:',
          'Base stats, Year Multiplier, Balance,',
          'Stacking Bonus, and Renown.',
          '',
          'Push stats above 15 for stacking bonuses.',
          'Max a stat at 20 for even more!',
          'Click the Score during gameplay',
        ...
        [
          ...
          'compete head-to-head. Each player',
          'picks one card to keep and sends',
          'the other to their opponent.',
