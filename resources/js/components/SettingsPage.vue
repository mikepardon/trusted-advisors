<template>
    <TaSubPage
        title="Settings"
        subtitle="Adjust your experience in the realm."
        back="/"
    >
                ...
                <div class="settings-group">
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc"
                                >Ambient music during gameplay</span
                            >
                        </div>
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc"
                                >Clicks, toggles, dice rolls</span
                            >
                        </div>
                        <button
                            class="toggle"
                ...
                <div class="settings-group">
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc"
                                >Helpful tips for new features as you
                                explore</span
                            >
                        </div>
                        <button
                ...
                <div class="settings-group">
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc"
                                >Turn reminders, game invites</span
                            >
                        </div>
                        <button
                            class="toggle"
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc"
                                >Friend requests and accepts</span
                            >
                        </div>
                        <button
                            class="toggle"
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            <span class="setting-desc"
                                >Daily and weekly challenges</span
                            >
                        </div>
                        <button
                            class="toggle"
                    ...
                    <div class="setting-row">
                        <div class="setting-info">
                            ...
                            >
                            <span class="setting-desc"
                                >Gifts and announcements from admins</span
                            >
                        </div>
                        <button
                            class="toggle"
