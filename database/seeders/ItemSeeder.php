...
class ItemSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            // === SCORE MODIFIER ITEMS (co-op only) ===
            [
                'name' => 'Royal Treasury Deed',
                'description' => 'An ancient deed granting rights to a forgotten royal vault. Its discovery brings immediate renown.',
            ...
            [
                ...
                'description' => 'A enchanted quill that records your kingdom\'s deeds for posterity. Each month adds to your legend.',
                'effect' => ['bonus_type' => 'score_per_round', 'bonus_value' => 2],
                'effect_type' => 'passive',
                'is_negative' => false,
                'is_consumable' => false,
                'available_cooperative' => true,
            ...
            [
                'name' => 'Bard\'s Lyre',
                'description' => 'A silver-stringed lyre whose songs amplify every tale of glory. Your renown grows faster.',
                'effect' => ['bonus_type' => 'score_multiplier', 'bonus_value' => 1.5],
                'effect_type' => 'passive',
                'is_negative' => false,
                'is_consumable' => false,
                'available_cooperative' => true,
            ...
            [
                ...
                'description' => 'A grand banner proclaiming your kingdom\'s might. Its presence inspires bards far and wide.',
                'effect' => ['bonus_type' => 'score_per_round', 'bonus_value' => 3],
                'effect_type' => 'passive',
                'is_negative' => false,
                'is_consumable' => false,
                'available_cooperative' => true,
            ...
            [
                ...
                'description' => 'A holy relic carried by a wandering pilgrim. Its presence blesses all who witness it.',
            ...
            [
                'name' => 'Fool\'s Gold Chalice',
                'description' => 'A cursed goblet that tarnishes your kingdom\'s reputation. Its false gleam fools no one.',
                'effect' => ['bonus_type' => 'score_bonus', 'bonus_value' => -10],
                'effect_type' => 'immediate',
                'is_negative' => true,
                'is_consumable' => true,
